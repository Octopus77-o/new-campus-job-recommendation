...
window.JOB_LIBRARY = [
  ...
  {
    "id": 4,
    "title": "Agentic训练与统一智能体演进研究-阿里星/C-Star",
    "department": "千问事业部",
    "location": "北京、杭州",
    ...
    "job_profile": {
      ...
      "core_problem": "我们正在重新定义“千问”：从一个博学的对话者进化为具备执行力的数字实体。我们的核心使命是构建一套统一的认知架构，打破模型与现实世界的壁垒，实现从“语义理解”到“任务闭环”的跨越，让 AI 真正深入生产力场景，实现数字世界与物理世界的高效连接。你将参与以下研究："
    }
  },
  {
    "id": 5,
    "title": "端到端语音智能体前沿技术研究-阿里星/C-Star",
    "department": "千问事业部",
    "location": "北京、杭州、上海",
    ...
    "job_profile": {
      ...
      "core_problem": "1、负责统一语音多模态大模型的设计、训练、优化，涵盖语音识别、语音合成、语音理解、文本-语音融合、跨模态检索与生成等方向"
    }
  },
  {
    "id": 6,
  ...
  {
    "id": 14,
    "title": "统一多模态大模型后训练算法研究-阿里星/C-Star",
    "department": "千问事业部",
    "location": "北京、杭州",
    ...
    "job_profile": {
      ...
      "core_problem": "针对当前多模态大模型在后训练阶段面临的模态割裂、对齐效率低、奖励信号稀疏且场景泛化能力弱等关键挑战，本课题聚焦于构建统一的多模态大模型后训练算法体系。研究内容主要包括三个方面："
    }
  },
  {
    "id": 15,
    "title": "智能体化多模态生成模型研究：从系统设计到实践应用-阿里星/C-Star",
    "department": "千问事业部",
    "location": "北京、杭州、上海",
    ...
    "job_profile": {
      ...
      "core_problem": "1、探索研究多模态生成大模型的设计与开发，探究高效生成、生成理解统一、多模态理解、强化学习/RLHF后训练和高效数据管线设计等方向"
    }
  },
  {
    "id": 16,
  ...
  {
    "id": 18,
    "title": "Agent自我学习进化与多Agent群体智能研究-阿里星/C-Star",
    "department": "千问事业部",
    "location": "北京、杭州",
    ...
    "job_profile": {
      ...
      "core_problem": "你将深度参与到千问核心Agent能力的技术探索和业务落地实践，围绕Agent能力的建设上探索面向未来的空间："
    }
  },
  {
    "id": 19,
    "title": "多模态Search Agent研究&应用-阿里星/C-Star",
    "department": "千问事业部",
    "location": "杭州",
    ...
    "job_profile": {
      ...
      "core_problem": "你将深度参与到千问VQA场景的优化&探索中，核心专注于提升 SearchAgent 在复杂视觉场景下的理解、推理及反思纠错能力。具体工作包括："
    }
  },
  {
    "id": 20,
  ...
  {
    "id": 34,
    "title": "大规模通用视频基础模型预训练-阿里星",
    "department": "Token Foundry",
    "location": "北京、杭州",
    "source": "https://campus-talent.alibaba.com/campus/position/199908720002",
    "description": "1. 集团战略级通用视频基础模型预训练全流程核心技术问题研究，如模型架构选用、稳定收敛技巧、效果检测、数据配比等。\n2. 全能参考视频生成和视频编辑技术问题研究，如可控信息注入方式、规模化编辑数据构造、统一模型训练技巧等。",
    "requirementsText": "1. 大规模多模态生成模型预训练和可控生成训练经验；\n2. 大模型团队协作经验和意识；\n\n加分项：\n1. 在大语言模型、多模态理解与生成模型等大模型相关领域有代表性工作；\n2. 具备数据工程、模型工程等全栈能力。",
    "required": [
      "基模",
      "视频生成",
      "视频编辑",
    ...
    "job_profile": {
      ...
      "must_have": [
        "1. 大规模多模态生成模型预训练和可控生成训练经验",
        "2. 大模型团队协作经验和意识",
        "加分项：",
        "1. 在大语言模型、多模态理解与生成模型等大模型相关领域有代表性工作",
        "2. 具备数据工程、模型工程等全栈能力。"
      ],
      "core_problem": "1. 集团战略级通用视频基础模型预训练全流程核心技术问题研究，如模型架构选用、稳定收敛技巧、效果检测、数据配比等。"
    }
  },
  {
    "id": 35,
